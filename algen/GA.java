...
public class GA {
    ...
    private double cc[][]; //populasi crossover
    private final double cm[][]; //mutation
    ...
    public void openDataset() throws FileNotFoundException{  
        String loc = "D:\\K\\S'''''''\\Alev\\Final Project\\";
...
//        System.out.println();
    ...
    public void printFitnessIndividuTerbaik(){
        //System.out.println("Fitness: "+this.pTerbaik[this.pTerbaik.length-1]);
